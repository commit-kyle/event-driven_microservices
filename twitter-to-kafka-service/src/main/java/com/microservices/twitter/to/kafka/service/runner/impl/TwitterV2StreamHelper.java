...
@Component
//  Loads the class only if the conditional returns true
...
//  Json representation of a tweet
    ...
    // correctly formats the date of a tweet
    private static final String TWITTER_STATUS_DATE_FORMAT = "EEE MMM dd HH:mm:ss zzz yyyy";

    public TwitterV2StreamHelper(TwitterToKafkaConfigData configData,
    ...
    private void createRules(String bearerToken, Map<String, String> rules) throws URISyntaxException, IOException {
        ...
        URIBuilder uriBuilder = new URIBuilder(configData.getTwitterV2RulesBaseUrl());
